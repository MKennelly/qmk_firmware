...
└─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
    */
    [_CW] = KEYMAP(
        ...
        KC_LSFT, 		KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_NO,   KC_RSPC, KC_NO,   \
...
└─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
	...
	[_QM] = KEYMAP(
        ...
        KC_LSFT, 		KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_NO,   KC_RSPC, KC_NO,   \
        KC_LCTL, 		KC_LALT, KC_LGUI,                            KC_SPC,                              KC_RGUI, KC_RALT, MO(5),   MO(4)),
